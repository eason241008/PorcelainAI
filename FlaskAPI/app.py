...
from model import Config, DiffusionWorker, InteractiveTuner, VLMWorker
...
@app.route('/interactive/analyze', methods=['POST'])
def interactive_analyze():
    ...
    try:
        ...
        img_pil = base64_to_pil(image_b64)
        result = vlm_worker.analyze_artifact(img_pil, style_desc, content_desc)
